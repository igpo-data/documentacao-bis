...
def render():
    ...
    with abas[0]:
      ...
      **CTRC** - *dim_CTRC*: utiliza a coluna nom_SiglaCTRC, o qual é todos os CTRC’s da tabela 455 durante aquele período filtrado. """)
        ...
        with col1:
                st.image(r"C:\Users\tamires\Desktop\Documentação\img\Performance_Geral_Autorizacao.png", caption="Tela filtrada pelo período de Autorização", use_container_width=True)
